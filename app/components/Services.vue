<template>
  <section class="bg-secondary" id="layanan">
    ...
    <div class="px-4 lg:px-20 py-16 lg:py-24">
      <div
        class="flex flex-col lg:flex-row lg:items-end justify-between gap-6 border-b border-white/10 pb-10"
      >
        <div class="max-w-2xl">
          <h2
            class="text-4xl lg:text-5xl font-black mb-6 uppercase text-white font-display"
          >
            Our Specialized <span class="text-primary italic">Services</span>
          </h2>
          <p class="text-neutral-light text-lg lg:text-xl">
            Layanan profesional yang dirancang untuk memenuhi ekspektasi visual
            tertinggi Anda.
          </p>
        </div>
      </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 min-h-[300px] lg:min-h-[400px]">
      ...
      >
        ...
        <!-- Content -->
        <div
          class="relative h-full flex flex-col justify-end p-8 lg:p-10 min-h-[400px] md:min-h-full"
        >
          <h3
            class="text-3xl lg:text-4xl font-bold text-white font-display mb-4"
          >
            {{ service.title }}
          </h3>
          <button
        ...
        >
          ...
          >
            ...
            <div v-if="activeService === 'master-studio'" class="p-6 lg:p-8">
              ...
              <div class="flex items-center gap-4 mb-6">
                <div class="flex flex-col">
                  <div class="flex">
                    ...
                    <div
                      class="w-3 h-6 bg-primary transform -skew-x-12 ml-0.5"
                    ></div>
                    <div
                      class="w-3 h-6 bg-primary transform -skew-x-12 ml-0.5"
                    ></div>
                ...
                <div>
                  <h3
                    class="text-xl lg:text-2xl font-black text-white font-display uppercase"
                  >
                    Master Studio
                  </h3>
              ...
              <!-- Description -->
              <p
                class="text-neutral-light text-sm lg:text-base leading-relaxed mb-6"
              >
                Tim profesional untuk kebutuhan foto dan video Anda. Mulai dari
                sesi foto studio, dokumentasi acara, hingga pengambilan video
                sinematik — kami siap mengabadikan momen penting Anda dengan
                kualitas terbaik.
              </p>
              ...
              <div class="flex flex-wrap gap-2 mb-6">
                <span
                  class="px-3 py-1.5 bg-primary/20 border border-primary/40 rounded-full text-white text-xs font-medium"
                  >Photo Studio</span
                >
                <span
                  class="px-3 py-1.5 bg-primary/20 border border-primary/40 rounded-full text-white text-xs font-medium"
                  >Fotografi Profesional</span
                >
                <span
                  class="px-3 py-1.5 bg-primary/20 border border-primary/40 rounded-full text-white text-xs font-medium"
                  >Videografi Cinematic</span
                >
                <span
                  class="px-3 py-1.5 bg-primary/20 border border-primary/40 rounded-full text-white text-xs font-medium"
                  >Drone Photography</span
                >
              </div>
            ...
            <div v-if="activeService === 'gallery-booth'" class="p-6 lg:p-8">
              ...
              <div class="flex items-center gap-4 mb-6">
                ...
                <h3
                  class="text-xl lg:text-2xl font-black font-display text-white"
                >
                  Gallery Booth
                </h3>
              </div>
              ...
              <p
                class="text-neutral-light text-sm lg:text-base leading-relaxed mb-6"
              >
                Spesialis penyedia layanan Photo Booth dan 360° Video Booth
                untuk berbagai acara. Hadirkan pengalaman dokumentasi interaktif
                yang seru dan memorable bagi tamu Anda dengan hasil foto dan
                video berkualitas tinggi yang dapat langsung dibagikan.
              </p>

              <!-- Services Tags -->
              <div class="flex flex-wrap gap-2 mb-6">
                <span
                  class="px-3 py-1.5 bg-[#14B8A6]/20 border border-[#14B8A6]/40 rounded-full text-white text-xs font-medium"
                  >Photo Booth</span
                >
                <span
                  class="px-3 py-1.5 bg-[#EC4899]/20 border border-[#EC4899]/40 rounded-full text-white text-xs font-medium"
                  >360° Video Booth</span
                >
                <span
                  class="px-3 py-1.5 bg-[#9333EA]/20 border border-[#9333EA]/40 rounded-full text-white text-xs font-medium"
                  >Event Activation</span
                >
              </div>

              <!-- Use Cases -->
              <p class="text-neutral-light/70 text-xs italic">
                Cocok untuk: Corporate Event, Wedding, Exhibition, Product
                Launch, Birthday Party, Graduation
              </p>
            ...
            <div v-if="activeService === 'photo-collage'" class="p-6 lg:p-8">
              ...
              <div class="flex items-center gap-3 mb-6">
                <h3 class="text-xl lg:text-2xl font-black font-display">
                  ...
                  <span class="inline-flex items-center ml-2">
                    ...
                    <span
                      class="w-2.5 h-2.5 rounded-full bg-[#3B82F6] ml-0.5"
                    ></span>
                    <span
                      class="w-2.5 h-2.5 rounded-full bg-[#EAB308] ml-0.5"
                    ></span>
                    <span
                      class="w-2.5 h-2.5 rounded-full bg-[#14B8A6] ml-0.5"
                    ></span>
                  </span>
                </h3>
              </div>
              ...
              <p
                class="text-neutral-light text-sm lg:text-base leading-relaxed mb-6"
              >
                Layanan cetak foto dan album premium untuk mengabadikan momen
                spesial Anda. Dari foto self-portrait, album pernikahan, hingga
                buku tahunan sekolah — kami wujudkan kenangan digital menjadi
                cetakan berkualitas tinggi yang bisa Anda simpan selamanya.
              </p>
              ...
              <div class="flex flex-wrap gap-2 mb-6">
                ...
                >
                <span
                  class="px-3 py-1.5 bg-[#EAB308]/20 border border-[#EAB308]/40 rounded-full text-white text-xs font-medium"
                  >Photo Box</span
                >
                <span
                  class="px-3 py-1.5 bg-[#3B82F6]/20 border border-[#3B82F6]/40 rounded-full text-white text-xs font-medium"
                  >Wedding Album</span
                >
                <span
                  class="px-3 py-1.5 bg-[#14B8A6]/20 border border-[#14B8A6]/40 rounded-full text-white text-xs font-medium"
                  >Yearbook Design</span
                >
                <span
                  class="px-3 py-1.5 bg-[#9333EA]/20 border border-[#9333EA]/40 rounded-full text-white text-xs font-medium"
                  >Premium Printing</span
                >
              </div>

              <!-- Use Cases -->
              <p class="text-neutral-light/70 text-xs italic">
                Cocok untuk: Wedding Photo, Family Portrait, Corporate Gift,
                School Yearbook
              </p>
              ...
              >
                <Slide
                  v-for="(portrait, index) in portraitCollage"
                  :key="index"
                >
                  <div class="services-card">
                    <NuxtImg
...
const mainServices = [
  ...
  },
  {
    ...
    overlayClass:
      "bg-gradient-to-t from-[#F59E0B]/80 via-[#F59E0B]/30 to-transparent",
  },
];
