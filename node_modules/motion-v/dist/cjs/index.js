...
class ProjectionFeature extends Feature {
  ...
  setOptions() {
    ...
    this.state.visualElement.projection.setOptions({
      ...
      onExitComplete: () => {
        var _a2, _b;
        if (!((_a2 = this.state.visualElement.projection) == null ? void 0 : _a2.isPresent) && this.state.options.layoutId) {
...
function usePresenceContainer(props) {
  ...
  function finalizeExit(containerState) {
    ...
    containerState.motions.forEach((state) => {
      var _a3;
      if (!((_a3 = state.element) == null ? void 0 : _a3.isConnected)) {
        state.unmount();
      }
    });
    (_c = (_b = containerState.motions) == null ? void 0 : _b[0]) == null ? void 0 : _c.didUpdate();
